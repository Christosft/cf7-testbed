package gr.aueb.cf1.ch19.sorting;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Product> products2 = Arrays.asList(new Product("", 12.5, 10),      // Immutable list
                new Product("", 12.5, 10));

        List<Product> products = new ArrayList<>(List.of(new Product("Apples", 12.5, 10),      // Immutable list
                new Product("Oranges", 12.5, 10), new Product("Berries", 12.5, 10)
        , new Product("Apples", 32.5, 20)));
